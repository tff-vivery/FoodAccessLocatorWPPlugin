...
function food_access_locator_shortcode() {
    return
        ...
        src="' + urlencode(get_option("food_access_locator_options")['region_token']) == "Production" ? 'https://food-access.azurewebsites.net/' : 'https://food-access-staging.azurewebsites.net/'
